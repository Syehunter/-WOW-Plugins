...
function SlashCmdList.IskarAssist (msg, editbox)
	...
	elseif (command == "resetpos") then
		...
		print ("|cFFFFAA00Iskar Assist|r:", "/iskar |cFFFFFF00maxgroups <amount>|r: 设置显示的最大队伍数.")
...
function IKA.BuildOptions (frame)
	...
	if (not frame.FirstRun) then
		...
		local strataTable = {}
		strataTable [1] = {value = "BACKGROUND", label = "背景", iconsize = texture_icon_size, statusbar = texturePath, onclick = set_frame_strata, icon = texture_icon, texcoord = texture_texcoord}
		strataTable [2] = {value = "LOW", label = "低", iconsize = texture_icon_size, statusbar = texturePath, onclick = set_frame_strata, icon = texture_icon, texcoord = texture_texcoord}
		strataTable [3] = {value = "MEDIUM", label = "中", iconsize = texture_icon_size, statusbar = texturePath, onclick = set_frame_strata, icon = texture_icon, texcoord = texture_texcoord}
		strataTable [4] = {value = "HIGH", label = "高", iconsize = texture_icon_size, statusbar = texturePath, onclick = set_frame_strata, icon = texture_icon, texcoord = texture_texcoord}
		strataTable [5] = {value = "DIALOG", label = "对话框", iconsize = texture_icon_size, statusbar = texturePath, onclick = set_frame_strata, icon = texture_icon, texcoord = texture_texcoord}
		-- endd
		...
		local stackTable = {}
		stackTable [1] = {value = "top", label = "顶", iconsize = texture_icon_size, statusbar = texturePath, onclick = set_stack_anchor, icon = texture_icon, texcoord = texture_texcoord}
		stackTable [2] = {value = "bottom", label = "底", iconsize = texture_icon_size, statusbar = texturePath, onclick = set_stack_anchor, icon = texture_icon, texcoord = texture_texcoord}
		stackTable [3] = {value = "left", label = "左", iconsize = texture_icon_size, statusbar = texturePath, onclick = set_stack_anchor, icon = texture_icon, texcoord = texture_texcoord}
		stackTable [4] = {value = "right", label = "右", iconsize = texture_icon_size, statusbar = texturePath, onclick = set_stack_anchor, icon = texture_icon, texcoord = texture_texcoord}
		--
		...
		local options_list = {
			...
			},
			{
				...
				max = 60,
				step = 1,
				desc = "每个框体的高度The height of each player frame.",
				name = "高度",
			},
			{
				type = "select",
			...
			{type = "blank"},
			{type = "label", get = function() return "文本:" end, text_template = DF:GetTemplate ("font", "ORANGE_FONT_TEMPLATE")},
