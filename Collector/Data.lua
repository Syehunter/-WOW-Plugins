...
do
    for i = 1, C_MountJournal.GetNumMounts() do
        local name, spellID, _, _, _, sourceType, _, isFactionSpecific, faction = C_MountJournal.GetMountInfo(i)

        MOUNT_DATA[spellID] = MOUNT_DATA[spellID] or {}

        sourceType = MOUNT_DATA[spellID] and MOUNT_DATA[spellID].Source or sourceType
        
        MOUNT_ID_TO_INDEX[spellID] = i
    ...
    for i = 1, C_PetJournal.GetNumPetTypes() do
        tinsert(PET_JOURNAL_FILTER_TYPES.Ability, {
            id = i,
