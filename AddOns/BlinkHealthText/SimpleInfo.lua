...
function S:ConstructCastingBar()	
	...
	_G[name.."Text"]:SetFontObject(SystemFont_Shadow_Small);	
	_G[name.."Text"]:ClearAllPoints();
	_G[name.."Text"]:SetPoint("LEFT", self.castBar, "LEFT", 4, 1);
	_G[name.."Text"]:SetJustifyH("LEFT");
	_G[name.."Text"]:SetWidth(100);
end
end
