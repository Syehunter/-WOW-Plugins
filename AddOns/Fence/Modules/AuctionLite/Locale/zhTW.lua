...
L["AuctionLite"] = "拍賣助手"
L["AuctionLite - Buy"] = "拍賣助手 - 購買"
L["AuctionLite - Sell"] = "拍賣助手 - 出售"
L["AuctionLite Buy"] = "拍賣助手 購買"
L["AuctionLite Sell"] = "拍賣助手 出售"
...
L["CANCEL_NOTE"] = [=[拍賣助手 只能每按一次取消一件物品因為內建的限制，所以只有一件你的拍賣被取消。

若要解決此問題，你可以繼續點"取消"按鈕直到所有需要的拍賣被取消。]=]
L["CANCEL_TOOLTIP"] = [=[|cffffffff點擊:|r 取消所有拍賣
|cffffffffCtrl-點擊:|r 取消削價拍賣]=]
L["CLEAR_DATA_WARNING"] = "你真的想要用拍賣助手刪除所有拍賣行收集到的價錢資料？"
L["Cancel"] = "取消"
L["Cancel All"] = "取消全部"
...
L["AuctionLite"]	= "拍賣助手";
L["AuctionLite Options"] = "拍賣助手-設置";
L["AuctionLite Buy"] = "拍賣助手-購買";
L["AuctionLite Sell"] = "拍賣助手-售賣";
L["AuctionLite Profiles"] = "配置當";
L["AuctionLite Favorites"] = "我的最愛";