...
EA_TTIP_SPECFLAG_HOLYPOWER = "Show HolyPower in the left 1st position of Self-Buffs";
EA_TTIP_SPECFLAG_RUNICPOWER = "Show RunicPower in the left 1st position of Self-Buffs";
EA_TTIP_SPECFLAG_SOULSHARDS = "Show SoulShards in the left 1st position of Self-Buffs";
EA_TTIP_SPECFLAG_ECLIPSE = "Show Eclipse in the left 1st position of Self-Buffs";
EA_TTIP_SPECFLAG_COMBOPOINT = "Show ComboPoint in the left 1st position of Target-DeBuffs";
EA_TTIP_SPECFLAG_LIFEBLOOM = "Show the Lifebloom timer and stack in the left 1st position of Self-Buffs"
...
EA_XOPT_SPECFLAG_HOLYPOWER = "HolyPower";
EA_XOPT_SPECFLAG_RUNICPOWER = "RunicPower";
EA_XOPT_SPECFLAG_SOULSHARDS = "SoulShards";
EA_XOPT_SPECFLAG_ECLIPSE = "Eclipse";
EA_XOPT_SPECFLAG_COMBOPOINT = "ComboPoints";
...
EX_XCLSALERT_LOADDEFAULT = "Load Default";
...
EA_XGRPALERT_POWERTYPES = {
	[1]={text="Mana", value=0},
	[2]={text="Rage", value=1},
	[3]={text="Focus", value=2},
	[4]={text="Energy", value=3},
	[5]={text="Happiness", value=4},
	[6]={text="Runic Power", value=6},
	[7]={text="Soul Shards", value=7},
	[8]={text="Eclipse", value=8},
	[9]={text="Holy Power", value=9}, };
