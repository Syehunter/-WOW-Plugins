...
function EventAlert_Icon_Options_Frame_Init()
	-- EA_Icon_Options_Frame_DriectionText1:SetText(EA_XICON_DIRECTION);
	-- EA_Icon_Options_Frame_DriectionText2:SetText(EA_XICON_DIRECTION);
	-- EA_Icon_Options_Frame_DriectionText3:SetText(EA_XICON_DIRECTION);
	...
	-- EA_Icon_Options_Frame_IconSize1:SetValue(EA_Position.IconSize1);
	-- EA_Icon_Options_Frame_IconSize2:SetValue(EA_Position.IconSize2);
	-- EA_Icon_Options_Frame_IconSize3:SetValue(EA_Position.IconSize3);
	-- EA_Icon_Options_Frame_IconSpace1:SetValue(EA_Position.IconSpace1);
	-- EA_Icon_Options_Frame_IconSpace2:SetValue(EA_Position.IconSpace2);
	-- EA_Icon_Options_Frame_IconSpace3:SetValue(EA_Position.IconSpace3);
...
function EventAlert_ToggleAlertFrameLock(switch)
	if (switch) then
