...
--			end
	...
	if "deDE" == locale then
		...
		S["ADD_ADVENTURE_GUIDE"] = "Zeigt in allen Gebieten die Quests aus dem Abenteuerführer an" -- Needs review
		S["ALL_FACTION_REPUTATIONS"] = "Zeige alle Ruffraktionen"
		...
		S["EMPTY_ZONES"] = "Zeige leere Zonen"
		...
		S["IGNORE_REPUTATION_SECTION"] = "Ignoriere Rufabschnitt bei Quests"
		S["IN_LOG"] = "Im Log"
...
-- 		S["EVER_EXPERIENCED"] = ""
		...
		S["HIGH_LEVEL"] = "Alto nivel" -- Needs review
...
-- 		S["LIVE_COUNTS"] = ""
		...
		S["LOW_LEVEL"] = "Bajo nivel" -- Needs review
		...
		S["OTHER"] = "Otro"
		S["OTHER_PREFERENCE"] = "Otra" -- Needs review
