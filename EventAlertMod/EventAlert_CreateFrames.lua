...
function EventAlert_CreateFrames()
	-- Create anchor frames used for mod customization.
		...
		CreateFrames_CreateAnchorFrame("EA_Anchor_Frame4", 1);
		CreateFrames_CreateAnchorFrame("EA_Anchor_Frame5", 2);
		CreateFrames_CreateAnchorFrame("EA_Anchor_Frame6", 2);
		CreateFrames_CreateAnchorFrame("EA_Anchor_Frame7", 2);
		CreateFrames_CreateAnchorFrame("EA_Anchor_Frame8", 2);
		CreateFrames_CreateAnchorFrame("EA_Anchor_Frame9", 3);
		CreateFrames_CreateAnchorFrame("EA_Anchor_Frame10", 3);
	-- Self Buff/Debuff
...
local GC_PowerType={[0]="MANA", [1]="RAGE", [2]="FOCUS", [3]="ENERGY", [4]="HAPPINESS", [5]="RUNES", [6]="RUNIC_POWER", [7]="SOUL_SHARDS", [8]="ECLIPSE", [9]="HOLY_POWER"};
