...
function BaseActivity:UpdateCustomData(comment, title)
    local summary, isMeetingStone, customId, version, mode, loot,
            class, itemLevel, progression, leaderPvPRating, minLevel, maxLevel, pvpRating, source, creator, savedInstance = DecodeCommetData(comment)
...
function BaseActivity:IsPvPActivity()
    return IsPvPActivity(self:GetActivityID())
end
